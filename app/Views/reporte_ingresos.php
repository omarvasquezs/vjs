    ...
    <div class="row mt-5 align-items-end">
        ...
        <div class="col-lg-2 col-md-12 mb-3">
            <div class="btn-group w-100" role="group">
                <button type="button" id="reporte_opciones" class="btn btn-primary btn-lg dropdown-toggle"
                    data-bs-toggle="dropdown" aria-expanded="false">
                    OPCIONES
                </button>
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item export-option" id="fetch_reporte_ingresos_web"
                            data-action="/fetch_reporte_ingresos_web" href="">VER EN WEB</a></li>
                    <li><a class="dropdown-item export-option" data-action="/exportexcel" href="">DESCARGAR XLSX</a>
                    </li>
